...
Eval compute in (runpgm initialEnv 203).

Lemma correct_property:
  forall E state g I g' pc m s i stack,
    runpgm initialEnv 201 = E ->
      E = myEnv state g I ->
